...
Cat.create({:name => "Freckles", :wins => 0, :loss => 0, :image => "http://s8.postimg.org/rhzsiqluc/freckles.jpg", :bio => "Freckles has a knowing look. Her parents were military personnel. She was brought up on the wrong side of the tracks and bought a boat. She has an oafish air. She found love through internet dating. Now she is plotting revenge on her old enemies.", :location => "New York, NY", :relationship => "from a distance", :birthday => "May 8, 2011", :naparea => "the tiled kitchen floor"})

Cat.create({:name => "Truman", :wins => 0, :loss => 0, :image => "http://s11.postimg.org/k9osn032b/truman.jpg", :bio => "Truman has a winning smile. The people he lived with were animals. He was brought up in a quiet suburb and started up an internet venture. He has sneering disdain for everyone. He found love through internet dating. Now he has a permanent tan.", :location => "Chicago, IL", :relationship => "single", :birthday => "May 8, 2011", :naparea => "on the book you're reading"})

Cat.create({:name => "Cheester", :wins => 0, :loss => 0, :image => "http://s21.postimg.org/5zh0tn63r/Cheester.jpg", :bio => "Cheester is bright and breezy. He has a lazy attitude. He was brought up by a single mother. When he graduated from junior college, he worked as an artist's model. He married the first person who asked him. When his partner died he had a nervous breakdown.", :location => "London", :relationship => "no way", :birthday => "May 8, 2011", :naparea => "on the book you're reading"})

Cat.create({:name => "Bob", :wins => 0, :loss => 0, :image => "http://s12.postimg.org/b87ykosi5/Bob.jpg", :bio => "Bob is bright and breezy. He has the classic good looks of a film star. He was a runaway. His parents were kind but misguided. He was educated by a mail order company based in Luxembourg. He married the girl next door. He has a criminal record.", :location => "New Haven, Connecticut", :relationship => "ready to mingle", :birthday => "May 8, 2011", :naparea => "on the book you're reading"})

Cat.create({:name => "Garfield", :wins => 0, :loss => 0, :image => "http://s11.postimg.org/gd8pirog3/Garfield.jpg", :bio => "Garfield is an abrupt and brusque personality. She has a ravaged face. She was educated by overhearing adult conversations in Uruguayan coffe houses. She was constantly in trouble as a child for causing mischief. Her parents were academics. After she got expelled from school she had a kid. Now she eats nothing but fast food.", :location => "LA", :relationship => "single", :birthday => "May 8, 2011", :naparea => "on the book you're reading"})

Cat.create({:name => "Mr.Yam Yam", :wins => 0, :loss => 0, :image => "http://s12.postimg.org/bu1iujcy5/Mr_Yam_Yam.jpg", :bio => "Mr. Yam Yam has the smooth features of an innocent. He was brought up by a single mother and after leaving school he joined a gang. He never married. When disaster struck he turned to amateur sleuthing. Now he spends his time harping back to the good old days.", :location => "Berwick, Maine", :relationship => "you wish", :birthday => "May 8, 2011", :naparea => "on the book you're reading"})

Cat.create({:name => "Spanky", :wins => 0, :loss => 0, :image => "http://s24.postimg.org/vybqqlxs5/Spanky.jpg", :bio => "Spanky has the strutting pose of a model. Her parents were restaurant owners. She was brought up on the wrong side of the tracks and broke her leg in a skiing accident. She has an aloofness. She found love through internet dating. Now she's writing their memoirs.", :location => "Minneapolis, MN", :relationship => "dating Bruce", :birthday => "May 8, 2011", :naparea => "on the book you're reading"})

Cat.create({:name => "Bruce", :wins => 0, :loss => 0, :image => "http://s9.postimg.org/5jtrj5b73/Bruce.jpg", :bio => "Bruce has a knowing look. He were brought up as a science experiment and after leaving school he joined the police. He never married. When insurgents staged a coup he took up painting. Now he visits the shrink once a week.", :location => "Your lap", :relationship => "casually dating Spanky", :birthday => "May 8, 2011", :naparea => "on the book you're reading"})
