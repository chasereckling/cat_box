...
Cat.create({:name => "Garfield", :wins => 0, :loss => 0, :image => "http://s11.postimg.org/gd8pirog3/Garfield.jpg", :bio => "Garfield is an abrupt and brusque personality. She has a ravaged face. She was educated by overhearing adult conversations. She was constantly in trouble as a child for causing mischief. Her parents were academics. After she got expelled from school she had a kid. Now she eats nothing but fast food.", :location => "LA", :relationship => "single", :birthday => "May 8, 2011", :naparea => "on the book you're reading"})
